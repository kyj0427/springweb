...
<body>
		<h1>글 등록</h1>		
		<hr>
		<!-- 1. 폼태그에 속성 추가  --> <!-- method는 반드시 post여야 한다 -->
		<form action="saveBoard.do" method='post' method='post' enctype="multipart/form-data"                      > 
			<table border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td align="left">
						<input type='file'/ name='file'><!-- boardvo에 파일이라는 이름이 있어야 화면이넘어감 -->
					</td>
				</tr>
